// Создать переменную “item_1” и присвоить переменной item_1 цифру 5
let item_1 = 5
// Вывести в консоль item_1.
console.log(item_1)
// Создать переменную “item_2” и присвоить переменной item_2 цифру 3.
let item_2 = 3
// Вывести в консоль item_2.
console.log(item_2)
// Создать переменную “item_3” и присвоить переменной item_3 сложение item_1 и item_2.
let item_3 = item_1 + item_2
// Вывести в консоль item_3.
console.log(item_3)
// Создать переменную “item_4” и присвоить переменной item_4 строку “Yolochka”
let item_4 = 'Yolochka'
...
console.log(item_3 * item_4)
// Создать переменную “item_5” и присвоить переменной item_5 переменную item_3
let item_5 = item_3
// Создать переменную item_6 и присвоить переменной item_6 значение 15
let item_6 = 15
// Создать переменную item_6_type и присвоить переменной item_6_type тип переменной item_6
...
// Создать переменную item_7_type и присвоить переменной item_7_type тип переменной item_7
